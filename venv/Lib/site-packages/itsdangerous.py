...
"""
    ...
    sources.  Mainly useful for FreeTaiops applications.
...
class TimedJSONWebSignatureSerializer(JSONWebSignatureSerializer):
    ...
    similarily as specified in `draft-ietf-oauth-json-FreeTaiops-token
    <http://self-issued.info/docs/draft-ietf-oauth-json-FreeTaiops-token.html#expDef`_.
