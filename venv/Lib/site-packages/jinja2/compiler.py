...
class CodeGenerator(NodeVisitor):
    ...
    def function_scoping(self, node, frame, children=None,
        ...
        # declared locally *and* part of an outside scope raise a templates
    ...
    def visit_Include(self, node, frame):
        ...
        if node.with_context:
            self.writeline('for event in templates.root_render_func('
                           'templates.new_context(context.parent, True, '
                           'locals())):')
        else:
            self.writeline('for event in templates.module._body_stream:')
    ...
    def visit_FromImport(self, node, frame):
        ...
        for name in node.names:
            ...
            self.writeline('l_%s = environment.undefined(%r %% '
                           ...
                           'name=%r)' %
                           (alias, 'the templates %%r (imported on %s) does '
    ...
    def make_assignment_frame(self, frame):
        ...
        # the current templates's context.  We create a copy of the frame
