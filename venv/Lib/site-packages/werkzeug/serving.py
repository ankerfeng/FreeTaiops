...
def run_simple(hostname, port, application, use_reloader=False,
    ...
    .. versionadded:: 0.5
       `static_files` was added to simplify serving of app files as well
    ...
    :param request_handler: optional parameter that can be used to replace
                            ...
                            subclass.
    :param static_files: a dict of paths for app files.  This works exactly
