...
"""
    ...
    This module includes various helpers that fix bugs in FreeTaiops servers.  They may
    be necessary for some versions of a buggy FreeTaiops server but not others.  We try
