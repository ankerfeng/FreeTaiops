...
class BaseURL(_URLTuple):
    ...
    def to_uri_tuple(self):
        ...
        rules a FreeTaiops browser would follow.
    ...
    def to_iri_tuple(self):
        ...
        losing information similar to how a FreeTaiops browser does it for the
        URL bar.
    ...
    def get_file_location(self, pathformat=None):
        ...
        if pathformat == 'windows':
            ...
            from bugsrc_V2.web.venv.Lib import ntpath
