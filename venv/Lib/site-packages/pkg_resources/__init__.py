...
from bugsrc_V2.web.venv.Lib.os import utime
try:
    from bugsrc_V2.web.venv.Lib.os import mkdir, rename, unlink
    WRITE_SUPPORT = True
except ImportError:
    # no write support, probably under GAE
    WRITE_SUPPORT = False

from bugsrc_V2.web.venv.Lib.os import open as os_open
from bugsrc_V2.web.venv.Lib.os.path import isdir, split
...
class WorkingSet(object):
    ...
    def find_plugins(self, plugin_env, full_env=None, installer=None,
        ...
        # run project names in alphabetic order
...
class NullProvider:
    ...
    def run_script(self, script_name, namespace):
        ...
        if os.path.exists(script_filename):
            ...
            from bugsrc_V2.web.venv.Lib.linecache import cache
...
def find_on_path(importer, path_item, only=False):
    ...
    if os.path.isdir(path_item) and os.access(path_item, os.R_OK):
        if path_item.lower().endswith('.egg'):
            ...
            # run for .egg and .egg-info in directory
