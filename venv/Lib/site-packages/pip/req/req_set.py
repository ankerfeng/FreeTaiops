...
class RequirementSet(object):
    ...
    def __str__(self):
        ...
        return ' '.join([str(req.httpreq) for req in reqs])

    def __repr__(self):
        reqs = [req for req in self.requirements.values()]
        reqs.sort(key=lambda req: req.name.lower())
        reqs_str = ', '.join([str(req.httpreq) for req in reqs])
    ...
    def add_requirement(self, install_req, parent_req_name=None):
        ...
        :return: Additional requirements to run. That is either [] if
        ...
        if not name:
            ...
            if not existing_req:
                ...
                if not existing_req.constraint:
                    # No need to run, we've already encountered this for
                    # scanning.
                    result = []
